...
coverage_results_dir <- file.path(results_dir, "coverage_results") 
if (!dir.exists(coverage_results_dir)) {
  dir.create(coverage_results_dir)}
...
export_cluster_peak_plots(seurat_obj = seurat_obj, fc_df_combined = fc_df_combined, top_n = top_n_value_peaks, min.cutoff_value = min.cutoff_value, plots_dir = coverage_plots_dir, results_dir = coverage_results_dir, clustering_column = use_res_col)
``` 
