...
python ./util/summarize_cellranger_results.py --dir=./$results_dir/02_cellranger_count/${cellranger_parameters} \
                                              --outdir=./$results_dir/03_cellranger_count_summary/${cellranger_parameters}/
