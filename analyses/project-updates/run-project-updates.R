...
pct_reads_in_peaks_value_upstream = yaml$pct_reads_in_peaks_value_upstream
blacklist_ratio_value_upstream = yaml$blacklist_ratio_value_upstream
TSS.enrichment_value_upstream =  yaml$TSS.enrichment_value_upstream
nucleosome_signal_value_upstream  = yaml$nucleosome_signal_value_upstream
