...
We will group the footprint signal by aggregating all cells together. Each line in the plot represents a single footprint profile per motif for all cell type groups, e.g., T cells, B cells.
