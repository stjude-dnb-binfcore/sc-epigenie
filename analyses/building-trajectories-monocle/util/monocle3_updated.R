# This is an updated version of the monocle3 function that is part of the `seurat-wrappers`. 
# See: https://github.com/satijalab/seurat-wrappers/blob/master/R/monocle3.R
#
# There is a bug/package conflict in the `as.cell_data_set` function that prohibits to properly run the function
# and convert Seurat object to a CellDataSet object
# 
# Comment out:`CheckPackage(package = 'cole-trapnell-lab/monocle3', repository = 'github')`
# Replace with: `rlang::check_installed("monocle3")`
#
#' @include internal.R
...
as.cell_data_set <- function(x, ...) {
  ...
  rlang::check_installed("monocle3")
