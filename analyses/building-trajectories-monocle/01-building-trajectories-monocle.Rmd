...
We can convert the Seurat object to a CellDataSet object using the as.cell_data_set() function from [SeuratWrappers](https://github.com/satijalab/seurat-wrappers) and build the trajectories using Monocle 3. We’ll do this separately for each lineage, but you could explore other strategies building a trajectory for all lineages together.
