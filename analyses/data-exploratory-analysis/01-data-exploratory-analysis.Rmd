...
```{r, fig.align = "left", results = "asis", message = FALSE, warning = FALSE, echo = FALSE}
tables1 <- df %>% count(experiment, seq_unit, assay, seq_technology, condition, Sample)
cat("  \n<div style=\"font-size:80%\">  \n")
caption_value = "Summary of samples per experiment, seq_unit, assay, seq_technology, condition, and Sample"
...
## Number of samples per experiment, seq_unit, assay, seq_technology, condition, and sample
